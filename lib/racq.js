 ...
 *
 * @author Guy Vider
 * @copyright  Traveling Tech Guy LLC 2014
 * @license  MIT
 */

/**
 * @class RacQ
 * @classdesc For further documentation: http://docs.rackspace.com/queues/api/v1.0/cq-devguide/content/overview.html
 *
 * @constructor 
...
var RacQ = function(options) {
	 ...
	 * @param  {Function} callback - Returns null on success, or error object
	 */
	this.deleteMessage = function(queueName, messageIds, callback) {
		var options = {
				url: getQueueUrl(queueName, true) + '/' + messageIds,
				headers: getRequestHeaders(true)
			};
